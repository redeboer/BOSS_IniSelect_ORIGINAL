...
void topoana::writeRsltIntoTxtFl()
{
  ...
  if(m_sttaDcyTrsAndDcyFSts == false)
  {
    ...
    for(unsigned long i = 0; i < nDcyTrsToBePrtd; i++)
    {
      dcyTr.clear();
      dcyTr = m_vDcyTr[i];
      fout << "index:  " << i + 1 << "\tiDcyTr:  " << m_vIDcyTr[i]
           << "\tiDcyFSt:  " << m_iDcyTrIDcyFStMap[m_vIDcyTr[i]] << "\tnEtrs:  " << m_vNDcyTr[i];
      if(m_ccSwitch == true)
      {
        fout << "\tnCcEtrs:  ";
        if(m_vICcDcyTr[i] == 0)
      ...
      for(unsigned int j = 0; j < m_vDcyFSt.size(); j++)
      {
        ...
        {
          dcyFSt.clear();
          if(m_iDcyTrICcDcyFStMap[m_vIDcyTr[i]] != -1)
            dcyFSt = m_vDcyFSt[j];
          else
            dcyFSt = m_vCcDcyFSt[j];
          break;
        }
      }
      fout << "(";
    ...
    for(unsigned long i = 0; i < nDcyFStsToBePrtd; i++)
    {
      dcyFSt.clear();
      dcyFSt = m_vDcyFSt[i];
      fout << "index:  " << i + 1 << "\tiDcyFSt:  " << m_vIDcyFSt[i]
           << "\tnEtrs:  " << m_vNDcyFSt[i];
      if(m_ccSwitch == true)
      {
        fout << "\tnCcEtrs:  ";
  ...
  if(m_vVDcyBrP.size() > 0)
  {
    for(unsigned int i = 0; i < m_vVDcyBrP.size(); i++)
    {
      ...
      for(unsigned int j = 0; j < nDcyBrPToBePrtd; j++)
      {
        ...
        fout << "index:  " << j + 1 << "\tiDcyBrP" << i + 1 << ":  " << m_vVIDcyBrP[i][j]
             << "\tnCases:  " << m_vVNDcyBrP[i][j];
        if(m_ccSwitch == true)
        {
          fout << "\tnCcCases:  ";
      ...
      if(nDcyBrPToBePrtd < m_vVDcyBrP[i].size())
      {
        ...
        if(m_ccSwitch == true)
        {
          ...
          else
          {
            ...
            fout << nCmltCasesOfRestTemp1 << "\tnCcCases:  " << nCmltCasesOfRestTemp2
                 << "\tnTotCases:  ";
          }
          for(unsigned int j = nDcyBrPToBePrtd; j < m_vVDcyBrP[i].size(); j++)
  ...
  if(m_vVDcyBrIncDcyBr.size() > 0)
  {
    for(unsigned int i = 0; i < m_vVDcyBrIncDcyBr.size(); i++)
    {
      ...
      for(unsigned int j = 0; j < nDcyBrIncDcyBrToBePrtd; j++)
      {
        ...
        fout << "index:  " << j + 1 << "\tiDcyBrIncDcyBr" << i + 1 << ":  "
             << m_vVIDcyBrIncDcyBr[i][j] << "\tnCases:  " << m_vVNDcyBrIncDcyBr[i][j];
        if(m_ccSwitch == true)
        {
          fout << "\tnCcCases:  ";
  ...
  if(m_vSigIncDcyBr.size() > 0)
  {
    ...
    for(unsigned int i = 0; i < m_vSigIncDcyBr.size(); i++)
    {
      ...
      fout << "index:  " << i + 1 << "\tiSigIncDcyBr:  " << m_vISigIncDcyBr[i]
           << "\tnCases:  " << m_vNSigIncDcyBr[i];
      if(m_ccSwitch == true)
      {
        fout << "\tnCcCases:  ";
  ...
  if(m_vSigSeqDcyBrs.size() > 0)
  {
    ...
    for(unsigned int i = 0; i < m_vSigSeqDcyBrs.size(); i++)
    {
      ...
      fout << "index:  " << i + 1 << "\tiSigSeqDcyBrs:  " << m_vISigSeqDcyBrs[i]
           << "\tnCases:  " << m_vNSigSeqDcyBrs[i];
      if(m_ccSwitch == true)
      {
        fout << "\tnCcCases:  ";
  ...
  if(m_vSigIncSeqDcyBrs.size() > 0)
  {
    ...
    for(unsigned int i = 0; i < m_vSigIncSeqDcyBrs.size(); i++)
    {
      ...
      fout << "index:  " << i + 1 << "\tiSigIncSeqDcyBrs:  " << m_vISigIncSeqDcyBrs[i]
           << "\tnCases:  " << m_vNSigIncSeqDcyBrs[i];
      if(m_ccSwitch == true)
      {
        fout << "\tnCcCases:  ";
  ...
  if(m_vSigIRADcyBr.size() > 0)
  {
    ...
    for(unsigned int i = 0; i < m_vSigIRADcyBr.size(); i++)
    {
      ...
      fout << "index:  " << i + 1 << "\tiSigIRADcyBr:  " << m_vISigIRADcyBr[i]
           << "\tnCases:  " << m_vNSigIRADcyBr[i];
      if(m_ccSwitch == true)
      {
        fout << "\tnCcCases:  ";
  ...
  if(m_vSigIncOrIRASeqDcyBrs.size() > 0)
  {
    ...
    for(unsigned int i = 0; i < m_vSigIncOrIRASeqDcyBrs.size(); i++)
    {
      ...
      fout << "index:  " << i + 1 << "\tiSigIncOrIRASeqDcyBrs:  " << m_vISigIncOrIRASeqDcyBrs[i]
           << "\tnCases:  " << m_vNSigIncOrIRASeqDcyBrs[i];
      if(m_ccSwitch == true)
      {
        fout << "\tnCcCases:  ";
      ...
      for(unsigned int j = 0; j < sigIncOrIRASeqDcyBrs.size(); j++)
      {
        ...
        { writePnmFromPid(fout, "TxtPnm", m_pidOfAnything); } fout << endl;
      }
      fout << endl;
    }
  }
  ...
  if(m_vSigDcyTr.size() > 0)
  {
    ...
    for(unsigned int i = 0; i < m_vSigDcyTr.size(); i++)
    {
      ...
      if(m_iSigDcyTrICcSigDcyFStMap[m_vISigDcyTr[i]] >= 0)
        ...
        fout << m_iSigDcyTrISigDcyFStMap[m_vISigDcyTr[i]] << "_cc";
      fout << "\tiDcyTr:  ";
      if(m_iSigDcyTrIDcyTrMap.find(m_vISigDcyTr[i]) != m_iSigDcyTrIDcyTrMap.end())
      {
        if(m_iSigDcyTrICcDcyTrMap[m_vISigDcyTr[i]] >= 0)
          ...
          fout << m_iSigDcyTrIDcyTrMap[m_vISigDcyTr[i]] << "_cc";
      }
      else
        fout << "---";
      fout << "\tiDcyFSt:  ";
         ...
         m_iSigDcyFStIDcyFStMap.end())
      {
        if(m_iSigDcyFStICcDcyFStMap[m_iSigDcyTrISigDcyFStMap[m_vISigDcyTr[i]]] >= 0)
          ...
          fout << m_iSigDcyFStIDcyFStMap[m_iSigDcyTrISigDcyFStMap[m_vISigDcyTr[i]]] << "_cc";
      }
      else
        fout << "---";
    ...
    for(unsigned int i = 0; i < m_vSigDcyFSt.size(); i++)
    {
      ...
      if(m_iSigDcyFStIDcyFStMap.find(m_vISigDcyFSt[i]) != m_iSigDcyFStIDcyFStMap.end())
      {
        if(m_iSigDcyFStICcDcyFStMap[m_vISigDcyFSt[i]] >= 0)
          ...
          fout << m_iSigDcyFStIDcyFStMap[m_vISigDcyFSt[i]] << "_cc";
      }
      else
        fout << "---";
    ...
    for(unsigned int i = 0; i < m_vSigDcyFSt2.size(); i++)
    {
      ...
      if(m_iSigDcyFSt2IDcyFStMap.find(m_vISigDcyFSt2[i]) != m_iSigDcyFSt2IDcyFStMap.end())
      {
        if(m_iSigDcyFSt2ICcDcyFStMap[m_vISigDcyFSt2[i]] >= 0)
          ...
          fout << m_iSigDcyFSt2IDcyFStMap[m_vISigDcyFSt2[i]] << "_cc";
      }
      else
        fout << "---";
