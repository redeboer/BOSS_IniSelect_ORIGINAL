...
void topoana::recurHighHierExchOrd(vector<int>& vIdxYngi, vector<int>& vIdxYngj, vector<int>& vPid,
                                   vector<int>& vMidx)
{
  ...
  while(vIdxYngi.size() != 0)
  {
    ...
    {
      vPidYngYngMid.clear();
      vMidxYngYngMid.clear();
      vIdxYngYngMid.clear();
      for(unsigned int k = ((unsigned int)(vIdxYngYngi[(vIdxYngYngi.size() - 1)] + 1));
          k < ((unsigned int)(vIdxYngYngj[0])); k++)
      {
      ...
      if(vVPidYngYngi != vVPidYngYngj)
      {
        ...
        if(exchOrd == true)
        {
          ...
          for(unsigned int k = 0; k < vIdxYngYngj.size(); k++)
            vOldIdxYngYng.push_back(vIdxYngYngj[k]);
          for(unsigned int k = 0; k < vIdxYngYngMid.size(); k++)
            vOldIdxYngYng.push_back(vIdxYngYngMid[k]);
          for(unsigned int k = 0; k < vIdxYngYngi.size(); k++)
            vOldIdxYngYng.push_back(vIdxYngYngi[k]);
