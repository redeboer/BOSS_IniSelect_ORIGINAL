...
void topoana::getSubsetsOfVPidandVMidxFromAP(vector<int>& vPid, vector<int>& vMidx,
                                             unsigned int idx)
{
  ...
  {
    cerr << "Error: The integer is not a reasonable index for the two vectors vPid and vMidx!"
         << endl;
