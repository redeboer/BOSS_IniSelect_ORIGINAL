  ...
  vector<vector<int> >& vVie2)
{
  if(via1.size() != via2.size() || via2.size() != vVLib1.size() || vVLib1.size() != vVLib2.size() ||
     ...
     vVid1.size() != vVid2.size() || vVid2.size() != vVie1.size() || vVie1.size() != vVie2.size())
  {
                                               ...
                                               vector<int>& vic1, vector<int>& vic2)
{
  if(via1.size() != via2.size() || via2.size() != vLib1.size() || vLib1.size() != vLib2.size() ||
     vLib2.size() != vic1.size() || vic1.size() != vic2.size())
  {
    cerr << "Error: The six vectors have different sizes!" << endl;
    cerr << "Infor: The size of the first vector is " << via1.size() << "." << endl;
    cerr << "Infor: The size of the second vector is " << via2.size() << "." << endl;
...
void topoana::sortBySumOf1stAnd2ndFromLrgToSml(vector<int>& via1, vector<int>& via2,
                                               vector<int>& vib1, vector<int>& vib2,
                                               vector<int>& vic1, vector<int>& vic2)
{
  if(via1.size() != via2.size() || via2.size() != vib1.size() || vib1.size() != vib2.size() ||
     vib2.size() != vic1.size() || vic1.size() != vic2.size())
  {
    cerr << "Error: The six vectors have different sizes!" << endl;
    cerr << "Infor: The size of the first vector is " << via1.size() << "." << endl;
    cerr << "Infor: The size of the second vector is " << via2.size() << "." << endl;
