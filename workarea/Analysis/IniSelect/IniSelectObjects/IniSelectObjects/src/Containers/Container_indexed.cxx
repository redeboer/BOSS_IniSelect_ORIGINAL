...
#include "IniSelectObjects/Containers/Container_indexed.h"

// * =========================== * //
// * ------- CONSTRUCTOR ------- * //
// * =========================== * //

/// The constructor, in addition to setting the name and description, attempts to add `Insert` an
/// instance of itself to the `fInstances` mapping.
...
/// A overload of `Container_base::SetName` that in addition to setting the name, safely redefines
/// its corresponding key in `fInstances`.
...
/// `value` into the `fInstances` mapping.
