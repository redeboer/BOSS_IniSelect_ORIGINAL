#ifndef Analysis_IniSelect_RecTrackPointers_H
#define Analysis_IniSelect_RecTrackPointers_H
...
/// `IniSelectObjects` inherits from this object.
/// @todo The pointers in this base class should be absorbed in subclasses at some stage.
