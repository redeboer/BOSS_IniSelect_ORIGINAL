...
/// @b OUTDATED Extension of `NTupleContainer` that represents the `NTuple` containing MC truth necessary for the `topoana` package. This object is still around, because it's `static` `IsJpsi` functions etc. are still required by `IniSelect` and derived classes.
