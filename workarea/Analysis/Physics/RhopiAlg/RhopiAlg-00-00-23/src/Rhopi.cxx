...
Rhopi::Rhopi(const std::string& name, ISvcLocator* pSvcLocator) : Algorithm(name, pSvcLocator)
{
...
StatusCode Rhopi::execute()
{
  ...
  for(int i = 0; i < nGood; i++)
  {
    ...
    //    if(pid->pdf(2)<pid->pdf(3)) continue; //  for Likelihood Method(0=electron 1=muon 2=pion
    //    3=kaon 4=proton)
