...
/// Commented version of the `RhopiAlg` example BOSS package (version `00-00-23`). The `RhopiAlg`
...
private:
  ...
  /// values for these cuts should be set in the RhopiAlg::RhopiAlg constructor (see cxx file).
  ///@{
  ...
  /// RhopiAlg::initialize() step. This is also the place where you name these variables, so make
