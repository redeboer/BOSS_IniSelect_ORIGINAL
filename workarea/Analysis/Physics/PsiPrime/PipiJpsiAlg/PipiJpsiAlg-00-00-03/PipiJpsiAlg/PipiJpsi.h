...
private:
  ...
  NTuple::Item<long>   m_event_flag; // 3 or 4 tracks, 4=>4 tracks, 0=> miss pi+, 1=> miss pi-, 2=>
                                     // miss lepton+, 3=> miss lepton-
  ...
  // we don't need smear, actually, assume one track of pi pi is missing, the recoil mass is
