...
static long m_cout_all(0), m_cout_col(0), m_cout_charge(0), m_cout_nGood(0), m_cout_mom(0),
  m_cout_recoil(0), m_cout_everat(0);
/////////////////////////////////////////////////////////////////////////////
  ...
  for(int i = 0; i < evtRecEvent->totalCharged(); i++)
  {
    ...
    if(mdcTrk->charge() > 0)
    {
      if(mdcTrk->p() < 1.0)
      {
        ...
        // function cannot be used, you should get momentum from MdcKalTrack, then calculate the
        // energy by yourself
