...
PipiJpsi::PipiJpsi(const std::string& name, ISvcLocator* pSvcLocator) : Algorithm(name, pSvcLocator)
{
...
StatusCode PipiJpsi::initialize()
{
  ...
  else
  {
    ...
    if(m_tuple1)
    {
      m_tuple1->addItem(
        "vx0",
        m_vx0); ///< tr><td>`"vx0"`</td><td>Primary \f$x\f$-vertex as determined by MDC</td></tr>
      m_tuple1->addItem(
        "vy0",
        m_vy0); ///< tr><td>`"vy0"`</td><td>Primary \f$y\f$-vertex as determined by MDC</td></tr>
      m_tuple1->addItem(
        "vz0",
        m_vz0); ///< tr><td>`"vz0"`</td><td>Primary \f$z\f$-vertex as determined by MDC</td></tr>
      m_tuple1->addItem(
        "vr0", m_vr0); ///< tr><td>`"vr0"`</td><td>Distance from origin in \f$xy\f$-plane</td></tr>
    }
    else
    {
  ...
  else
  {
    ...
    if(m_tuple2)
    {
      m_tuple2->addItem("dthe", m_dthe); ///< tr><td>`"dthe"`</td><td>\f$\theta\f$ angle difference
                                         ///< with nearest charged track (degrees)</td></tr>
      m_tuple2->addItem("dphi", m_dphi); ///< tr><td>`"dphi"`</td><td>\f$\phi\f$ angle difference
                                         ///< with nearest charged track (degrees)</td></tr>
      m_tuple2->addItem(
        "dang",
        m_dang); ///< tr><td>`"dang"`</td><td>Angle difference with nearest charged track</td></tr>
  ...
  if(m_checkDedx)
  {
    ...
    else
    {
      ...
      if(m_tuple3)
      {
        m_tuple3->addItem("ptrk",
                          m_ptrk); ///< tr><td>`"ptrk"`  </td><td>Momentum of the track</td></tr>
        m_tuple3->addItem(
          "chie",
          m_chie); ///< tr><td>`"chie"`  </td><td>\f$\chi^2\f$ in case of electron </td></tr>
        m_tuple3->addItem(
          "chimu", m_chimu); ///< tr><td>`"chimu"` </td><td>\f$\chi^2\f$ in case of muon </td></tr>
        m_tuple3->addItem(
          "chipi", m_chipi); ///< tr><td>`"chipi"` </td><td>\f$\chi^2\f$ in case of pion </td></tr>
        m_tuple3->addItem(
          "chik", m_chik); ///< tr><td>`"chik"`  </td><td>\f$\chi^2\f$ in case of kaon </td></tr>
        m_tuple3->addItem(
          "chip", m_chip); ///< tr><td>`"chip"`  </td><td>\f$\chi^2\f$ in case of proton </td></tr>
        m_tuple3->addItem("probPH", m_probPH); ///< tr><td>`"probPH"`</td><td>Most probable pulse
                                               ///< height from truncated mean</td></tr>
        m_tuple3->addItem(
          "normPH", m_normPH); ///< tr><td>`"normPH"`</td><td>Normalized pulse height</td></tr>
        m_tuple3->addItem("ghit",
                          m_ghit); ///< tr><td>`"ghit"`  </td><td>Number of good hits</td></tr>
        m_tuple3->addItem("thit",
                          m_thit); ///< tr><td>`"thit"`  </td><td>Total number of hits</td></tr>
      }
      else
      {
  ...
  if(m_checkTof)
  {
    ...
    else
    {
      ...
      if(m_tuple4)
      {
        m_tuple4->addItem("ptrk", m_ptot_etof); ///< tr><td>`"ptrk"`</td><td>Momentum of the track
        ...
        m_tuple4->addItem("cntr", m_cntr_etof); ///< tr><td>`"cntr"`</td><td>ToF counter
                                                ///< ID</td></tr>
        m_tuple4->addItem("ph", m_ph_etof); ///< tr><td>`"ph"`  </td><td>ToF pulse height</td></tr>
        m_tuple4->addItem(
          "rhit",
          m_rhit_etof); ///< tr><td>`"rhit"`</td><td>Track extrapolate Z or R Hit position</td></tr>
        m_tuple4->addItem(
          "qual",
          m_qual_etof); ///< tr><td>`"qual"`</td><td>Data quality of reconstruction</td></tr>
        m_tuple4->addItem("te", m_te_etof); ///< tr><td>`"te"`  </td><td>Difference with ToF in
  ...
  if(m_checkTof)
  {
    ...
    else
    {
      ...
      if(m_tuple5)
      {
        m_tuple5->addItem("ptrk", m_ptot_btof1); ///< tr><td>`"ptrk"`</td><td>Momentum of the track
                                                 ///< as reconstructed by MDC</td></tr>
        ...
        m_tuple5->addItem("cntr",
                          m_cntr_btof1);     ///< tr><td>`"cntr"`</td><td>ToF counter ID</td></tr>
        m_tuple5->addItem("ph", m_ph_btof1); ///< tr><td>`"ph"`  </td><td>ToF pulse height</td></tr>
        m_tuple5->addItem("zhit", m_zhit_btof1); ///< tr><td>`"zhit"`</td><td>Track extrapolate Z or
                                                 ///< R Hit position</td></tr>
        m_tuple5->addItem(
          "qual",
  ...
  if(m_checkTof)
  {
    ...
    else
    {
      ...
      if(m_tuple6)
      {
        m_tuple6->addItem("ptrk", m_ptot_btof2); ///< tr><td>`"ptrk"`</td><td>Momentum of the track
                                                 ///< as reconstructed by MDC</td></tr>
        ...
        m_tuple6->addItem("cntr",
                          m_cntr_btof2);     ///< tr><td>`"cntr"`</td><td>ToF counter ID</td></tr>
        m_tuple6->addItem("ph", m_ph_btof2); ///< tr><td>`"ph"`  </td><td>ToF pulse height</td></tr>
        m_tuple6->addItem("zhit", m_zhit_btof2); ///< tr><td>`"zhit"`</td><td>Track extrapolate Z or
                                                 ///< R Hit position</td></tr>
        m_tuple6->addItem(
          "qual",
  ...
  {
    m_tuple8 =
      ntupleSvc()->book("FILE1/infmom", CLID_ColumnWiseTuple, "information with momentum method");
    if(m_tuple8)
    {
      // * Momenta * //
      m_tuple8->addItem("momlepmm", m_mom_lepm); ///< tr><td>`"momlepmm"`</td><td>4-momentum of the
                                                 ///< identified negative lepton</td></tr>
      m_tuple8->addItem(
        "momlepp",
        m_mom_lepp); ///< tr><td>`"momlepp"` </td><td>4-momentum of the positive pion</td></tr>
      m_tuple8->addItem("mompionm", m_mom_pionm); ///< tr><td>`"mompionm"`</td><td>4-momentum of the
                                                  ///< identified negative lepton</td></tr>
      m_tuple8->addItem(
        "mompionp",
        m_mom_pionp); ///< tr><td>`"mompionp"`</td><td>4-momentum of the positive pion</td></tr>
      // * Geometry * //
      m_tuple8->addItem(
        "pipidang",
      ...
      m_tuple8->addIndexedItem(
        ...
        m_cos_theta); ///< tr><td>`"costhe"` </td><td>\f$\cos(\theta)\f$ of the lorentz vector in
                      ///< the cylindrical coordinate system</td></tr>
      m_tuple8->addIndexedItem(
        "phi", m_index, m_phi); ///< tr><td>`"phi"`    </td><td>\f$\phi\f$ angle of the lorentz
                                ///< vector in the cylindrical coordinate system</td></tr>
      m_tuple8->addIndexedItem(
        "fourmom", m_index, 4,
        m_four_mom); ///< tr><td>`"fourmom"`</td><td>\f$E\f$, \f$p_x\f$, \f$p_y\f$, and \f$p_z\f$
                     ///< for each lepton/pion (hence a \f$4\times4\f$ matrix)</td></tr>
      // * Invariant masses * //
      m_tuple8->addItem(
        "invtwopi",
        m_mass_twopi); ///< tr><td>`"invtwopi"`</td><td>Invariant mass of the two pions.</td></tr>
      ...
      m_tuple8->addItem("totene", m_tot_e); ///< tr><td>`"totene"`</td><td>Total energy of the
                                            ///< \f$J/\psi \pi\pi\f$ system</td></tr>
      m_tuple8->addItem("totpx", m_tot_px); ///< tr><td>`"totpx"` </td><td>Total \f$p_x\f$ of the
                                            ///< \f$J/\psi \pi\pi\f$ system</td></tr>
      m_tuple8->addItem("totpy", m_tot_py); ///< tr><td>`"totpy"` </td><td>Total \f$p_y\f$ of the
                                            ///< \f$J/\psi \pi\pi\f$ system</td></tr>
      m_tuple8->addItem("totpz", m_tot_pz); ///< tr><td>`"totpz"` </td><td>Total \f$p_z\f$ of the
                                            ///< \f$J/\psi \pi\pi\f$ system</td></tr>
      // * Ratios * //
      m_tuple8->addItem(
        "epratio",
      ...
      m_tuple8->addItem(
        ...
        m_trans_ratio_lepm); ///< tr><td>`"tplepratiom"` </td><td>Ratio of the 4-momentum axial
                             ///< distance (\f$\rho\f$ in the cylindrical coordinate system) versus
                             ///< \f$|\vec{p}|\f$ for the negative lepton.</td></tr>
      m_tuple8->addItem(
        "tplepratiop",
        m_trans_ratio_lepp); ///< tr><td>`"tplepratiop" `</td><td>Ratio of the 4-momentum axial
                             ///< distance (\f$\rho\f$ in the cylindrical coordinate system) versus
                             ///< \f$|\vec{p}|\f$ for the positive lepton.</td></tr>
      m_tuple8->addItem(
        "tppionratiom",
        m_trans_ratio_pionm); ///< tr><td>`"tppionratiom"`</td><td>Ratio of the 4-momentum axial
                              ///< distance (\f$\rho\f$ in the cylindrical coordinate system) versus
                              ///< \f$|\vec{p}|\f$ for the negative pion.</td></tr>
      m_tuple8->addItem(
        "tppionratiop",
        m_trans_ratio_pionp); ///< tr><td>`"tppionratiop"`</td><td>Ratio of the 4-momentum axial
                              ///< distance (\f$\rho\f$ in the cylindrical coordinate system) versus
                              ///< \f$|\vec{p}|\f$ for the positive pion.</td></tr>
      // * Indices * //
      ...
      m_tuple8->addItem("ntrack", m_index, 0,
                        4); ///< tr><td>`"ntrack"`</td><td>For indexed item. Ranges from `0` to `3`:
                            ///< for \f$\pi^+\f$, \f$\pi^-\f$, \f$l^+\f$, and \f$l^-\f$</td></tr>
      // * Matches * //
      m_tuple8->addItem(
        "pionmat",
        m_pion_matched); ///< tr><td>`"pionmat"`</td><td>Number of identified pions</td></tr>
      m_tuple8->addItem("lepmat",
                        m_lep_matched); ///< tr><td>`"lepmat"` </td><td>Number of identified leptons
                                        ///< (actually non-pions)</td></tr>
      // * Monte Carlo truth * //
      m_tuple8->addItem("indexmc", m_idxmc, 0,
                        100); ///< tr><td>`"indexmc"`</td><td>Total number of (useful) MC particles
                              ///< in this event (used for the arrays)</td></tr>
      m_tuple8->addIndexedItem(
        "pdgid", m_idxmc,
...
StatusCode PipiJpsi::execute()
{
  ...
  */
  ...
  for(int i = 0; i < evtRecEvent->totalCharged(); ++i)
  {
    ...
    if(mdcTrk->charge() > 0)
    {
      ...
      { // pi+
        ...
        // @warning If you do not modify the `DstMdcKalTrack` package, the `RecMdcKalTrack::p4()`
        // function cannot be used. You should get the momentum from `MdcKalTrack`, then calculate
  ...
  /// <li> Angle difference between pions, suppress gamma convertion. @attention This is an
  /// important part of the `PipiJpsi` algorithm! <ul> <li> Compute angle between pions
  ...
  else if(m_mass_recoil > 3.08 && m_mass_recoil < 3.12 && m_mass_jpsi > 3.0 && m_mass_jpsi < 3.2 &&
          m_cms_lepp < 1.7 && m_cms_lepp > 1.4 && m_cms_lepm < 1.7 && m_cms_lepm > 1.4 &&
          m_event_flag == 4 && m_pipi_dang < m_pipi_dang_cut)
    setFilterPassed(true);

  /// </ul>

  /// <li> Monte Carlo information. @attention This is an important part of the `PipiJpsi`
  /// algorithm!
  ...
  /// <li> Selection of 'good' photons. Note that these aren't really used, as the process \f$\psi'
  /// \rightarrow \pi\pi J/\psi \rightarrow \pi\pi ll\f$ doesn't involve photons.
  Vint iGam;
  iGam.clear();
...
/// over all events. Prints the flow chart to the terminal, so make sure you save this output!
