#ifndef Physics_Analysis_D0phi_3Kpi_H
#define Physics_Analysis_D0phi_3Kpi_H
...
/// @date     May 18th, 2018
class D0phi_3Kpi : public Algorithm
{
public:
  /// @name Constructors
  ///@{
  D0phi_3Kpi(const std::string& name, ISvcLocator* pSvcLocator);
  ///@}
...
private:
  ...
  // ! ------- DECLARE CUTS HERE ------- ! //
  // ! ================================= ! //
  /// @name Cut parameters. Here, you can define data members that you use to define cuts. The values for these cuts should be set in the D0phi_3Kpi::D0phi_3Kpi constructor (see cxx file).
  ///@{
