...
public:
  ...
  KKFitResult_rhopi_pipigg(Event::McParticle* photon1, Event::McParticle* photon2,
  ...
  double
    fM_JpsiRho0; ///< Current computed mass of the \f$J/\psi \rightarrow \rho^0\pi^0\f$ candidate.
  double
    fM_JpsiRhom; ///< Current computed mass of the \f$J/\psi \rightarrow \rho^-\pi^+\f$ candidate.
  double
    fM_JpsiRhop; ///< Current computed mass of the \f$J/\psi \rightarrow \rho^+\pi^-\f$ candidate.
  ///@}

private:
  /// @name Setters
  ///@{
  void SetValues(const HepLorentzVector& pPhoton1, const HepLorentzVector& pPhoton2,
                 const HepLorentzVector& pPionNeg, const HepLorentzVector& pPionPos);
  void SetValues(Event::McParticle* photon1, Event::McParticle* photon2, Event::McParticle* pionNeg,
