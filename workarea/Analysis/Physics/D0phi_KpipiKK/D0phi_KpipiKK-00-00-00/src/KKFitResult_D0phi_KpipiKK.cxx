...
/// Construct a `KKFitResult_D0phi_KpipiKK` object based on a pointer to a `KalmanKinematicFit`
/// object.
...
KKFitResult_D0phi_KpipiKK::KKFitResult_D0phi_KpipiKK(
  ...
  Event::McParticle* pionPos, Event::McParticle* photon1, Event::McParticle* photon2) :
  KKFitResult(nullptr)
{
...
void KKFitResult_D0phi_KpipiKK::SetValues(Event::McParticle* kaonNeg1, Event::McParticle* kaonNeg2,
                                          ...
                                          Event::McParticle* photon1, Event::McParticle* photon2)
{
  ...
  SetValues(kaonNeg1->initialFourMomentum(), kaonNeg2->initialFourMomentum(),
            kaonPos->initialFourMomentum(), pionPos->initialFourMomentum(),
            photon1->initialFourMomentum(), photon2->initialFourMomentum());
  /// </ol>
}

/// Helper function for the constructor (hence `private` method).
void KKFitResult_D0phi_KpipiKK::SetValues(const HepLorentzVector& pKaonNeg1,
