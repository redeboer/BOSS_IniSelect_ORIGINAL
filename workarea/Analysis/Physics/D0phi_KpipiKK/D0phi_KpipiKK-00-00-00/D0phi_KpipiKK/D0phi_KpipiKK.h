...
protected:
  ...
  std::vector<Event::McParticle*>::iterator
    fMcKaonNeg1Iter; ///< Iterator for looping over the MC collection of negative kaons (1st
                     ///< occurence).
  std::vector<Event::McParticle*>::iterator
    fMcKaonNeg2Iter; ///< Iterator for looping over the MC collection of negative kaons (2st
                     ///< occurence).
  std::vector<Event::McParticle*>::iterator
    fMcKaonPosIter; ///< Iterator for looping over the MC collection of positive kaons.
  std::vector<Event::McParticle*>::iterator
  ...
  std::vector<EvtRecTrack*> fKaonNeg; ///< Vector that contains a selection of pointers to charged
                                      ///< tracks identified as \f$K^-\f$. @todo Decide if this can
                                      ///< be formulated in terms of some `fEvtRecTrackMap`.
  ...
  CutObject fCutFlow_mD0_mphi; ///< **Cut flow counter**: number of events that passed the wide
                               ///< cut on both masses.
  CutObject fCutFlow_mD0_mphi_3sig; ///< **Cut flow counter**: number of events that passed the
