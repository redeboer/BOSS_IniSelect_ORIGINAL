#ifndef Physics_Analysis_D0omega_Kenu3pi_H
#define Physics_Analysis_D0omega_Kenu3pi_H
...
public:
  /// @name Constructors
  ///@{
  D0omega_Kenu3pi(const std::string& name, ISvcLocator* pSvcLocator);
  ///@}
...
private:
  ...
  // ! ------- DECLARE CUTS HERE ------- ! //
  // ! ================================= ! //
  /// @name Cut parameters. Here, you can define data members that you use to define cuts. The values for these cuts should be set in the D0omega_Kenu3pi::D0omega_Kenu3pi constructor (see cxx file).
  ///@{
