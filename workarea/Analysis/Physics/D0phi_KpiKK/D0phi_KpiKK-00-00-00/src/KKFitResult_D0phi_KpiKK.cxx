...
/// Construct a `KKFitResult_D0phi_KpiKK` object based on a pointer to a `KalmanKinematicFit`
/// object.
KKFitResult_D0phi_KpiKK::KKFitResult_D0phi_KpiKK(KalmanKinematicFit* kkmfit) : KKFitResult(kkmfit)
{
  if(!fFit) return;
...
/// Construct a `KKFitResult_D0phi_KpiKK` object based on a pointer to a `KalmanKinematicFit`
/// object.
KKFitResult_D0phi_KpiKK::KKFitResult_D0phi_KpiKK(Event::McParticle* kaonNeg1,
...
void KKFitResult_D0phi_KpiKK::SetValues(Event::McParticle* kaonNeg1, Event::McParticle* kaonNeg2,
...
/// Helper function for the constructor (hence `private` method).
void KKFitResult_D0phi_KpiKK::SetValues(const HepLorentzVector& pKaonNeg1,
