...
/// @{
	...
	namespace TSGlobals
	{
		const double gM_rho  = 0.77526;    ///< Mass of \f$\rho^{0\pm}\f$, see [PDG](http://pdg.lbl.gov/2018/listings/rpp2018-list-rho-770.pdf).
		const double gM_pi0  = 0.1349770;  ///< Mass of \f$\pi^0\f$, see [PDG](http://pdg.lbl.gov/2018/listings/rpp2018-list-pi-zero.pdf).
		const double gM_pi   = 0.13957061; ///< Mass of \f$\pi^\pm\f$, see [PDG](http://pdg.lbl.gov/2018/listings/rpp2018-list-pi-plus-minus.pdf).
		const double gM_K    = 0.493677;   ///< Mass of \f$K^\pm\f$.
		const double gM_D0   = 1.86483;    ///< Mass of \f$D^0\f$, see [PDG](http://pdg.lbl.gov/2018/listings/rpp2018-list-D-zero.pdf).
		const double gM_phi  = 1.019461;   ///< Mass of \f$\phi\f$, see [PDG](http://pdg.lbl.gov/2018/listings/rpp2018-list-phi-1020.pdf).
		const double gM_omega = 0.78265;   ///< Mass of \f$\omega\f$, see [PDG](http://pdg.lbl.gov/2018/listings/rpp2018-list-omega-782.pdf).
		const double gM_Jpsi = 3.0969;     ///< Mass of \f$J/\psi\f$, see [PDG](http://pdg.lbl.gov/2018/listings/rpp2018-list-J-psi-1S.pdf).
