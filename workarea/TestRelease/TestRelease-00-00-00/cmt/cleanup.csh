...
${CMTROOT}/mgr/cmt cleanup -csh -pack=TestRelease -version=TestRelease-00-00-00 -path=${BOSSWORKAREA}/workarea  $* >${cmtTestReleasetempfile}
if ( $status != 0 ) then
  echo "${CMTROOT}/mgr/cmt cleanup -csh -pack=TestRelease -version=TestRelease-00-00-00 -path=${BOSSWORKAREA}/workarea  $* >${cmtTestReleasetempfile}"
