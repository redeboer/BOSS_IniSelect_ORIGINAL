#ifndef Reconstruction_DsReconstruction_H
#define Reconstruction_DsReconstruction_H
...
class DsReconstruction : public Algorithm
{
...
public:
  ...
  void           savetrack(vector<int>, vector<int>, EvtRecTrackIterator, EvtRecTrackIterator,
                           EvtRecTrackIterator, EvtRecTrackIterator, EvtRecDTag*);
