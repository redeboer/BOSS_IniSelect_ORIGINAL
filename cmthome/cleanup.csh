...
${CMTROOT}/mgr/cmt cleanup -csh -pack=cmt_standalone -version=v0 -path=/besfs/users/deboer/BOSS_Afterburner/boss/cmthome  $* >${cmtcmt_standalonetempfile}
if ( $status != 0 ) then
  echo "${CMTROOT}/mgr/cmt cleanup -csh -pack=cmt_standalone -version=v0 -path=/besfs/users/deboer/BOSS_Afterburner/boss/cmthome  $* >${cmtcmt_standalonetempfile}"
