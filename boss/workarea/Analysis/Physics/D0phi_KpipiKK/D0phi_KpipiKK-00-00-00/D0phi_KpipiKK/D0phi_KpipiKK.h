...
/// @{
	...
	/// @todo Design another package for \f$K^-\pi^+\pi^-pi^+pi^- \pi^-\pi^+\f$ (branching fraction \f$(8.11 ± 0.15)\%\f$, see [\f$D^0\f$ PDG listing](http://pdg.lbl.gov/2018/listings/rpp2018-list-D-zero.pdf)). However, that does mean the final state will become rather complicated: \f$ J/\psi \rightarrow D^0\phi \rightarrow K^-\pi^+\pi^+\pi^- \pi^-\pi^+ \f$.
